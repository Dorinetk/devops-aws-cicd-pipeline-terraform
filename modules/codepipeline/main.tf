...
data "aws_s3_bucket" "tf_codepipeline_artifact_bucket" {
  bucket = var.tf_codepipeline_artifact_bucket_name
}

output "tf_codepipeline_artifact_bucket_arn" {
  value = data.aws_s3_bucket.tf_codepipeline_artifact_bucket.arn
}
...
resource "aws_codepipeline" "tf_codepipeline" {
  ...
  artifact_store {
    location = data.aws_s3_bucket.tf_codepipeline_artifact_bucket.bucket
    type     = "S3"
  }
